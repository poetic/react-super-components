...
var SuperImage = function (_React$Component) {
  ...
  (0, _createClass3.default)(SuperImage, [{
    ...
    value: function render() {
      ...
      switch (status) {
        case 'NOT_IN_VIEW':
          return _react2.default.cloneElement(loadingComponent) || _react2.default.createElement(ImageLoading, null);
        case 'ERROR':
          return _react2.default.cloneElement(errorComponent) || _react2.default.createElement(ImageError, null);
        case 'SHOW':
