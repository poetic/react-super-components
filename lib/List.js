  ...
  checkTypesAndReturnMatchingItemType(index, data) {
    ...
    switch (itemTypes.constructor) {
      case (Array): {
        ...
        throw new Error(
          'SuperList: A data props object failed to match a passed type from itemTypes props.'
        );
      }
      ...
      default:
        throw new Error('SuperList: itemTypes props must be an Array or an Object.');
    }
  }
...
List.propTypes = {
  ...
  data: (props, propName, componentName) => {
    ...
    let dataWithNonMatchingTypeProperty = 0;
